...
public class ConversionExchangeDTO implements Serializable {
	/**
	 * 
	 */
	...
	public ConversionExchangeDTO() {

	}

	public ConversionExchangeDTO(String countryCode, double countryfactor) {
		super();
